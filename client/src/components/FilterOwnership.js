    ...
    <div className="flex justify-center ml-2 my-3">
      ...
      <div className="form-check form-check-inline">
        <input
          ...
          type="radio"
          name="ownership"
          id="ownershipOptionUser"
          value="user"
          checked={ filter.ownership === 'user' }
          onChange={ (e) => handleRadioGroupChange(e) }
        />
        <label className="form-check-label inline-block text-gray-800 font-mono" htmlFor="ownershipOptionUser">My Dudes!</label>
      </div>
    </div>
    );
}
